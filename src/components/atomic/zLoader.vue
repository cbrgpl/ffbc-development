...
export default {
  ...
  computed: {
    ...
    backgroundSize () {
      return !this.background ? {}
        : {
          height: 1.25 * this.height + 'px',
          width: 1.25 * this.width + 'px'
        }
    }
  },
}
